//package com.takeaway.referee.controller;
//
//import java.time.Duration;
//
//import javax.annotation.PostConstruct;
//
//import com.takeaway.referee.amqp.MessageListenerContainerFactory;
...
//
//    public AmqpReactiveController(AmqpTemplate amqpTemplate,
//                                  AmqpAdmin amqpAdmin,
...
//     * @return
//     */
//    @GetMapping(value = "/queue/{name}", produces = MediaType.APPLICATION_NDJSON_VALUE)
...
//    }
//
//    @GetMapping(value = "/topic/{name}", produces = MediaType.APPLICATION_NDJSON_VALUE)
